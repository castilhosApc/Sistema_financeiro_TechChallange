      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-8 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-primary-custom dark:text-white">Histórico de Transações</h2>
          ...
          <div className="space-y-4">
            {transactions.length === 0 ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-400 text-sm">Crie sua primeira transação!</p>
              </div>
            ) : (
